...
// A simple, self-contained Google icon component
const GoogleIcon = () => (
...
// A simple, self-contained GitHub icon component
const GitHubIcon = () => (
  <svg
    role="img"
    viewBox="0 0 24 24"
...
interface SocialLoginButtonProps extends React.ComponentPropsWithoutRef<typeof Button> {
  provider: Provider;
  // We can add onClick handlers if we need specific logic per button
  onClick?: () => void;
}
...
const SocialLoginButton: React.FC<SocialLoginButtonProps> = ({
  ...
  console.log(`SocialLoginButton for ${provider} loaded.`);
